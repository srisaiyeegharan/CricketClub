...
<?php
	...
	else
	{
		...
		{
			$umpire= sanitise($_POST["umpire_id_one"]);

			
			$query = "DELETE FROM $sql_table WHERE UmpireId = $umpire";
			...
			if (!$result)
				{
					...
					echo"<a class='button fit' href='delete_umpire.php'>Go Back</a>";
					echo"</div>";
				...
				else
				{
					...
					header("location:delete_umpire.php");
