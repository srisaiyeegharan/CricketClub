...
<?php
	...
	else
	{
		...
		if(isset($_POST["player_role_id"])) 
			{
			$playerid = sanitise($_POST["player_id"]);
			$playerrole= sanitise($_POST["player_role_id"]);
			}
			
			$query = "INSERT INTO $sql_table (PlayerId, RoleId) VALUES ('$playerid', '$playerrole')";
			$result = mysqli_query($conn, $query);
			if ($result)
			{
				header("location:player_successful.php");
			}
			else 
			{
				...
				echo"<div class='container'>";
					echo"<header class='major'>";
						echo"<h4>Please Enter a valid Role ID</h4>";
					echo"</header>";
				echo"<div class='container 25%'>";
				echo"<a class='button fit' href='register_player_role.php'>Go Back</a>";
				echo"</div>";
